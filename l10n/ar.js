OC.L10N.register(
    ...
    "This app can be used  for auditing shares within a Nextcloud instance e.g. for data loss prevention.\n\n- Review any file share\n  - files, talk, deck, teams, federation\n  - additional apps (apps can register)\n- Remove shares\n- Confirm current review\n  - show only new shares next time\n- Audit compliance\n- Assign review to user groups (e.g. audit or risk mgmt)\n\nNote:\nThe app must be restricted to at least one specific user group in the app store.\nThis prevents accidental exposure of the shared content to all users." : "يمكن استخدام هذا التطبيق لفحص وتدقيق المشاركات داخل خادوم نكست كلاود؛ على سبيل المثال، لمنع فقدان البيانات DLP. \n\n- مراجعة أي مشاركة لملف \n- تطبيقات: الملفات، المحادثة، بطاقات المهام، الفرق، السحابة الاتحادية \n- تطبيقات إضافية: (يمكن تسجيلها) \n- إزالة المشاركات \n- تأكيد المراجعة الحالية \n- إظهار المشاركات الجديدة فقط في المرة القادمة \n- الامتثال للتدقيق \n- إسناد مهمة المراجعة لمجموعات من المستخدمين (على سبيل المثال مجموعة التدقيق أو إدارة المخاطر) \n\nملاحظة: \nيجب تقييد التطبيق بمجموعة مستخدمين واحدة على الأقل في متجر التطبيقات. يمنع هذا التعريض العرضي للمحتوى المشترك لجميع المستخدمين.",
