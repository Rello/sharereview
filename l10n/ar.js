OC.L10N.register(
    ...
    "- Review and audit all shares within the Nextcloud instance\n- Remove shares\n- Confirm review\n- Audit compliance\n- Show only new shares since last review\n- Assign review to user groups (e.g. audit or risk mgmt)\n\n### Note:\nThe app must be restricted to at least one specific user group in the app store.\nThis prevents accidental exposure of the shared content to all users." : "قم بمراجعة وتدقيق جميع المشاركات داخل خادوم نكست كلاود \n- إزالة المشاركات \n- تأكيد المراجعة \n- الامتثال للتدقيق \n- عرض المشاركات الجديدة فقط منذ المراجعة الأخيرة \n- تعيين المراجعة لمجموعات المستخدمين (مثل إدارة التدقيق أو إدارة المخاطر) \n\n###ملاحظة: يجب أن يقتصر التطبيق على مجموعة مستخدمين محددة واحدة على الأقل في متجر التطبيقات. وهذا يمنع العرض العَرَضي للمحتوى المشترك لجميع المستخدمين.",
