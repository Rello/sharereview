OC.L10N.register(
    ...
    "- Review and audit all shares within the Nextcloud instance\n- Remove shares\n- Confirm review\n- Audit compliance\n- Show only new shares since last review\n- Assign review to user groups (e.g. audit or risk mgmt)\n\n### Note:\nThe app must be restricted to at least one specific user group in the app store.\nThis prevents accidental exposure of the shared content to all users." : "- Gennemgå og revider alle delinger i Nextcloud-instansen\n- Fjern delinger\n- Bekræft gennemgang\n- Overholdelse af revision\n- Vis kun nye delinger siden sidste anmeldelse\n- Tildel gennemgang til brugergrupper (f.eks. revision eller risikostyring)\n\n### Bemærk:\nAppen skal være begrænset til mindst én specifik brugergruppe i appbutikken.\nDette forhindrer utilsigtet eksponering af det delte indhold til alle brugere.",
